...
function InputGroup({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/input-group relative flex h-11 w-full min-w-0 items-center rounded-md border border-input bg-card transition-colors outline-none focus-within:border-foreground in-data-[slot=combobox-content]:focus-within:border-inherit has-data-[align=block-end]:rounded-md has-data-[align=block-start]:rounded-md has-[[data-slot][aria-invalid=true]]:border-destructive has-[textarea]:rounded-md has-[>[data-align=block-end]]:h-auto has-[>[data-align=block-end]]:flex-col has-[>[data-align=block-start]]:h-auto has-[>[data-align=block-start]]:flex-col has-[>textarea]:h-auto has-[>[data-align=block-end]]:[&>input]:pt-3 has-[>[data-align=block-start]]:[&>input]:pb-3 has-[>[data-align=inline-end]]:[&>input]:pr-2 has-[>[data-align=inline-start]]:[&>input]:pl-2 motion-reduce:transition-none',
        className,
      )}
      {...props}
    />
